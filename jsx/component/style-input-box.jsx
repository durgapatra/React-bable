...
export default class StyleInpBox extends React.Component {
    ...
    onFocusInPutBox() {
        this.refs.inputBoxBorder.style.borderBottom = "2px solid blue";
    ...
    onBlurInp() {
        if (!this.refs.inputBox.value) {
            this.refs.inputBoxBorder.style.borderBottom = "2px solid gray";
    ...
    componentDidUpdate() {
        if (this.props.onRed == true) {
            this.refs.inputBoxBorder.style.borderBottom = "2px solid red";
    ...
    render() {
        return (
            <div className="main-inputContainer" ref="inputContainer" style={this.props.Width ? { width: this.props.Width } : { width: "200px" }}>
                ...
                <span ref="inputBoxBorder" style={this.props.Width ? { width: this.props.Width } : { width: "200px" }} className="inputBoxBorder"></span>
